...
namespace TheDialgaTeam.Cryptonote.Rpc.Worktips.Http
{
    ...
    {
        public HttpRpcClient(string host, int port, string? username = null, string? password = null, HttpRpcClientOptions? httpRpcClientOptions = null, Action<HttpClient>? implementationAction = null) : this($"{host}:{port}", username, password, httpRpcClientOptions, implementationAction)
        {
        }
