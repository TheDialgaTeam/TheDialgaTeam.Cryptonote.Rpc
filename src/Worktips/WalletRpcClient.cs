...
namespace TheDialgaTeam.Cryptonote.Rpc.Worktips
{
    public class WalletRpcClient : IDisposable
    {
        ...
        public WalletRpcClient(string host, int port = 31024, string? username = null, string? password = null, HttpRpcClientOptions? httpRpcClientOptions = null, Action<HttpClient>? implementationAction = null)
        {
        ...
        {
            return await _httpRpcClient.GetHttpJsonRpcResponseAsync<CommandRpcGetBalance.Response, CommandRpcGetBalance.Request>("get_balance", new CommandRpcGetBalance.Request { AccountIndex = accountIndex, AddressIndices = addressIndices }, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await _httpRpcClient.GetHttpJsonRpcResponseAsync<CommandRpcGetAddress.Response, CommandRpcGetAddress.Request>("get_address", new CommandRpcGetAddress.Request { AccountIndex = accountIndex, AddressIndex = addressIndex }, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await _httpRpcClient.GetHttpJsonRpcResponseAsync<CommandRpcGetAccounts.Response, CommandRpcGetAccounts.Request>("get_accounts", new CommandRpcGetAccounts.Request { Tag = tag }, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await _httpRpcClient.GetHttpJsonRpcResponseAsync<CommandRpcCreateAccount.Response, CommandRpcCreateAccount.Request>("create_account", new CommandRpcCreateAccount.Request { Label = label }, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await _httpRpcClient.GetHttpJsonRpcResponseAsync<CommandRpcGetHeight.Response>("get_height", cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await _httpRpcClient.GetHttpJsonRpcResponseAsync<CommandRpcTransferSplit.Response, CommandRpcTransferSplit.Request>("transfer_split", request, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            await _httpRpcClient.GetHttpJsonRpcResponseAsync<JsonRpc.Response>("store", cancellationToken).ConfigureAwait(false);
        }
