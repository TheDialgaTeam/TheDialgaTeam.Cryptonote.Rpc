...
[![Deploy To NuGet Registry](https://github.com/TheDialgaTeam/TheDialgaTeam.Cryptonote.Rpc/actions/workflows/deploy.yml/badge.svg)](https://github.com/TheDialgaTeam/TheDialgaTeam.Cryptonote.Rpc/actions/workflows/deploy.yml)

# TheDialgaTeam.Cryptonote.Rpc
...
This library provides Worktips Daemon Rpc interface and Wallet Rpc interface for consumption.
...
```sh
dotnet add package TheDialgaTeam.Cryptonote.Rpc --version 1.0.0
```
